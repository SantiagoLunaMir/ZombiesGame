    ...
    public void spawnZombies(){
        ...
        if(count%spawnSpeed==0 && zombiesSpawned>=49 && zombiesSpawned<60){
            ...
            if(zombiesSpawned==59){
                ...
                addObject(new ZombieBoss(mainPlayer,counter),100,100);
                zombiesSpawned+=4;
            }
            if(zombiesSpawned==63){
                addObject(new ZombieBoss(mainPlayer,counter),0,800);
                addObject(new ZombieBoss(mainPlayer,counter),700,0);
                addObject(new ZombieBoss(mainPlayer,counter),400,800);
                addObject(new ZombieBoss(mainPlayer,counter),100,100);
                zombiesSpawned+=4;
            }
        }
